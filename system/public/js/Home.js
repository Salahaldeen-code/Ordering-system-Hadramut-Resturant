	...
	$.ajax({
		...
		success: function(data){
			...
			$.each (data, function (key, item){
				...
				<p class="float-right font-weight-bold cl mr-2" style="font-size: 130%;line-height: 50px">RM `+item.quanlity*item.price+`</p>
				</div>
			...
			$('#total-text').text('RM '+parseInt(total));
		}
	});
}
